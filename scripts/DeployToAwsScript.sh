...
eks_cluster_name="bharath-cloud-automation-cluster"
node_group_name="bharath-cloud-automation-nodegroup"
node_type="t3.large"
wanted_nodes="1"
min_nodes="1"
max_nodes="2"
application_properties="/var/lib/jenkins/workspace/Test_Pipepline_Selenium_Automation_MFA/application.properties"
ssh_public_key_path="/var/lib/jenkins/workspace/Test_Pipepline_Selenium_Automation_MFA/myPublicKey.pub"
helm_charts_path="/var/lib/jenkins/workspace/Test_Pipepline_Selenium_Automation_MFA/aaf_helm_chart"
ebs_sc_yaml="/var/lib/jenkins/workspace/Test_Pipepline_Selenium_Automation_MFA/scripts/ebs-sc.yaml"
trust_policy_json="/var/lib/jenkins/workspace/Test_Pipepline_Selenium_Automation_MFA/scripts/trust-policy.json"
trust_policy_backup_json="/var/lib/jenkins/workspace/Test_Pipepline_Selenium_Automation_MFA/scripts/trust-policy-backup.json"
